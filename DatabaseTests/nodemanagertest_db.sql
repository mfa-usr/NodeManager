...
IF EXISTS (SELECT 1 FROM master.dbo.sysdatabases
				WHERE name = 'nodemanagertest_db')
BEGIN
	DROP DATABASE nodemanagertest_db
	print '' print '*** dropped database nodemanagertest_db ***'
END

print '' print '*** creating database nodemanagertest_db ***'

CREATE DATABASE nodemanagertest_db

print '' print '*** using database nodemanagertest_db ***'
